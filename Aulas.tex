...
$$
Var(X) =  \frac{r(r-1)n(n-1)}{N(N-1)} +  \frac{rn}{N} - \bigg(\frac{rn}{N}\bigg)^2 = \frac{r}{N}
\bigg(
\frac{(r-1)n(n-1)}{(N-1)} + 1- \frac{rn^2}{N} 
\bigg)
$$
$$
=  \frac{r(r-1)n(n-1)}{N(N-1)} +  \frac{rn}{N} - \bigg(\frac{rn}{N}\bigg)^2
 = \frac{rn}{N}
\bigg(
