...
Seja X uma variável aleatória definida em $(\Omega,\mathscr{A},P)$. Uma variável aleatória denotada por $ W = E(X| \mathscr A)$, é a esperança condicional de X dado $\mathscr A$, se :
\begin{enumerate}
	\item $\sigma(W)\subset \mathscr A$
	\item $E(X\cdot I_A) = E(W I_A), \forall A \in \mathscr A$ quase certamente (Exceto, A t.q. P(A)=0)
\end{enumerate}
